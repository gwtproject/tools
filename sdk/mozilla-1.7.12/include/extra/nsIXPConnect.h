/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM c:/sandbox/bld-mozilla/js/src/xpconnect/idl/../../../../../mozilla/js/src/xpconnect/idl/nsIXPConnect.idl
 */
...
class NS_NO_VTABLE nsIXPConnectWrappedNative : public nsIXPConnectJSObjectHolder {
 public: 
...
#define NS_IXPCONNECT_IID_STR "efae37b0-946d-11d2-ba58-00805f8a5dd7"
...
class nsIXPConnect : public nsISupports {
 public: 
  ...
  NS_IMETHOD InitClassesWithNewWrappedGlobal(JSContext * aJSContext, nsISupports *aCOMObj, const nsIID & aIID, PRBool aCallJS_InitStandardClasses, nsIXPConnectJSObjectHolder **_retval) = 0;
...
#define NS_DECL_NSIXPCONNECT \
  ...
  NS_IMETHOD InitClassesWithNewWrappedGlobal(JSContext * aJSContext, nsISupports *aCOMObj, const nsIID & aIID, PRBool aCallJS_InitStandardClasses, nsIXPConnectJSObjectHolder **_retval); \
...
#define NS_FORWARD_NSIXPCONNECT(_to) \
  ...
  NS_IMETHOD InitClassesWithNewWrappedGlobal(JSContext * aJSContext, nsISupports *aCOMObj, const nsIID & aIID, PRBool aCallJS_InitStandardClasses, nsIXPConnectJSObjectHolder **_retval) { return _to InitClassesWithNewWrappedGlobal(aJSContext, aCOMObj, aIID, aCallJS_InitStandardClasses, _retval); } \
...
#define NS_FORWARD_SAFE_NSIXPCONNECT(_to) \
  ...
  NS_IMETHOD InitClassesWithNewWrappedGlobal(JSContext * aJSContext, nsISupports *aCOMObj, const nsIID & aIID, PRBool aCallJS_InitStandardClasses, nsIXPConnectJSObjectHolder **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->InitClassesWithNewWrappedGlobal(aJSContext, aCOMObj, aIID, aCallJS_InitStandardClasses, _retval); } \
...
/* nsIXPConnectJSObjectHolder initClassesWithNewWrappedGlobal (in JSContextPtr aJSContext, in nsISupports aCOMObj, in nsIIDRef aIID, in PRBool aCallJS_InitStandardClasses); */
NS_IMETHODIMP nsXPConnect::InitClassesWithNewWrappedGlobal(JSContext * aJSContext, nsISupports *aCOMObj, const nsIID & aIID, PRBool aCallJS_InitStandardClasses, nsIXPConnectJSObjectHolder **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
